...
<head>
  ...
  <script src="https://use.typekit.net/hab5szb.js"></script>
...
<body class="<?php print $classes; ?>">
  ...
  <?php if ($_GET['q'] == 'civicrm/contribute/transact'): ?>
    <div class="navigation-section-alt">
      <div id="header-usa">
        <a href="https://www.youthbuild.org">
          <img id="logo" src="/sites/all/themes/yb2014/img/single/YBUSA-YBI_Colored.png">
        </a>
    </div>
  <?php else:; ?>
    <div class="navigation-section">
      <a href="https://www.youthbuild.org" class="logo-main"><span></span></a>
    </div>
  <?php endif; ?>
  </header>
        ...
        <section>
          <div class="col-sm-12">
            <article class="main-article">
              ...
              <?php print $header; ?>
              <?php print $highlight; ?>
              <?php if ($title): ?><h1 class="page-header"><?php print $title; ?></h1><?php endif; ?>
              <?php print $messages; ?>
