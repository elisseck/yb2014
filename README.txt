...
// Info about this theme from Echo & Co.
// ----------------------------------------------

It is a copy of the zen based ybcivi theme, with all the css (less) from the new youtbuild
website copied over to it. So there is a lot of CSS in here that is uncessary - but it was 
only meant as temporary, quick fix since time is limited.


// Getting Started
// ----------------------------------------------

If you have never used grunt before on your machine - follow the instructions here: http://gruntjs.com/getting-started

If it exists, delete the 'node_modules' directory.

In the theme root, run: 'npm install'

now run, 'grunt watch' and everytime you save a less file it will get compiled into css and put in the right place.

FYI - there are other grunt tasks inside of gruntfile.js but they we're intended for use on the youthbuild site. For this website you should only use grunt to compile your less into css.



// The stuff below was not written by Echo & Co. - it came when copied over from ybcivi theme
// ----------------------------------------------
